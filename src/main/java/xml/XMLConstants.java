...
public class XMLConstants {
    ...
    public static final String MESSAGE = "service";

    //xml编码
    public static final String ENCODING = "UTF-8";

    // xsd默认命名空间,设置为空则没有默认命名空间
    public static final String XSD_DEFAULT_NAMESPACE = "xsd";

    // xsd定义的默认数据节点，设置为空则认为根目录为默认数据节点
    public static final String XSD_DEFAULT_DATANODE = "annotation";
